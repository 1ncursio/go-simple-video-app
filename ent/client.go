...
import (
	...
	"github.com/1ncursio/go-simple-video-app/ent/migrate"
...
// QueryVideos queries the videos edge of a Tag.
func (c *TagClient) QueryVideos(t *Tag) *VideoQuery {
...
// QueryTags queries the tags edge of a Video.
func (c *VideoClient) QueryTags(v *Video) *TagQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2M, false, video.TagsTable, video.TagsPrimaryKey...),
		)
