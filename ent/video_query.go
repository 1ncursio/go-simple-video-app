...
func (vq *VideoQuery) QueryTags() *TagQuery {
	query := &TagQuery{config: vq.config}
...
func (vq *VideoQuery) WithTags(opts ...func(*TagQuery)) *VideoQuery {
	query := &TagQuery{config: vq.config}
...
func (vq *VideoQuery) sqlAll(ctx context.Context) ([]*Video, error) {
	...
	if query := vq.withTags; query != nil {
		...
		_spec := &sqlgraph.EdgeQuerySpec{
			...
			Predicate: func(s *sql.Selector) {
				s.Where(sql.InValues(video.TagsPrimaryKey[0], fks...))
			},
