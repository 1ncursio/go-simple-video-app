...
func (e TagEdges) VideosOrErr() ([]*Video, error) {
	if e.loadedTypes[0] {
		return e.Videos, nil
	}
...
// QueryVideos queries the "videos" edge of the Tag entity.
func (t *Tag) QueryVideos() *VideoQuery {
	return (&TagClient{config: t.config}).QueryVideos(t)
}
