...
func (vc *VideoCreate) SetViews(i int) *VideoCreate {
	vc.mutation.SetViews(i)
	return vc
}

// SetNillableViews sets the "views" field if the given value is not nil.
func (vc *VideoCreate) SetNillableViews(i *int) *VideoCreate {
	if i != nil {
		vc.SetViews(*i)
	}
	return vc
...
func (vc *VideoCreate) AddTagIDs(ids ...int) *VideoCreate {
	vc.mutation.AddTagIDs(ids...)
	return vc
}

// AddTags adds the "tags" edges to the Tag entity.
func (vc *VideoCreate) AddTags(t ...*Tag) *VideoCreate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
	return vc.AddTagIDs(ids...)
}
...
func (vc *VideoCreate) createSpec() (*Video, *sqlgraph.CreateSpec) {
	...
	if nodes := vc.mutation.TagsIDs(); len(nodes) > 0 {
